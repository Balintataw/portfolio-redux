 ...
 *
 * todos:
 * 		Need to fix extramovable elements animations. For example, need to fix the direction of the animation for the content element when it's on the left or under the tabs.
